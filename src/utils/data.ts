...
interface IUser {
  ...
  // Add other properties from IUser if needed
}
...
interface IThoughtSeed {
  ...
  reactions: IReaction[];
  // Add other properties from IThought if needed
}

type UserSeed = Omit<IUser, keyof Document | 'friendCount'>;
...
export const thoughts: IThoughtSeed[] = [
  {
